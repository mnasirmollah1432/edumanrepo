...
var MultiSelectHeader = exports.MultiSelectHeader = function (_Component) {
    ...
    _createClass(MultiSelectHeader, [{
        ...
        value: function render() {
            ...
            var checkboxIcon = (0, _classnames2.default)('ui-chkbox-icon ui-clickable', { 'fa fa-check': this.props.allChecked });
            ...
            if (this.props.filter) {
                filterElement = _react2.default.createElement(
                    ...
                    _react2.default.createElement('span', { className: 'fa fa-fw fa-search' })
                );
            }
